...
-- PROCEDURES de cadastros 
CREATE OR REPLACE PROCEDURE PROC_CADASTRAR_HOSPEDE (CPF_HOSPEDE VARCHAR2, NOME_HOSPEDE VARCHAR2 DEFAULT NULL) IS
BEGIN
...
CREATE OR REPLACE PROCEDURE PROC_CADASTRAR_HOTEL (NUM_HOTEL NUMBER DEFAULT NULL, CEP_HOTEL VARCHAR2 DEFAULT NULL) IS
BEGIN
    ...
    DBMS_OUTPUT.PUT_LINE('Hotel cadastrado');
END;


CREATE OR REPLACE PROCEDURE PROC_CADASTRAR_FLAT (COD_HOTEL NUMBER, NUM_FLAT NUMBER, STATUS_FLAT VARCHAR2 DEFAULT NULL) IS
BEGIN
    ...
    DBMS_OUTPUT.PUT_LINE('Flat cadastrado');
END;

CREATE OR REPLACE PROCEDURE PROC_CADASTRAR_SERVICOS_ADICIONAIS (NOME_SERVICO VARCHAR2, CUSTO_ADICIONAL VARCHAR2 DEFAULT NULL) IS
BEGIN
    INSERT INTO SERVICOS_ADICIONAIS VALUES (
        SEQ_SERVICOS_ADICIONAIS.nextval,
        NOME_SERVICO,
        CUSTO_ADICIONAL
    );
    DBMS_OUTPUT.PUT_LINE('Serviço adicional cadastrado');
END;

CREATE OR REPLACE PROCEDURE PROC_CADASTRAR_FUNCIONARIO (CPF_FUNCIONARIO VARCHAR2, NOME_FUNCIONARIO VARCHAR2 DEFAULT NULL, CARGO_FUNCIONARIO VARCHAR2 DEFAULT NULL, CPF_CHEFE VARCHAR2 DEFAULT NULL, COD_HOTEL NUMBER) IS
BEGIN
...
CREATE OR REPLACE PROCEDURE PROC_CADASTRAR_CRACHA (DT_EMISSAO_CRACHA DATE, CPF_FUNCIONARIO VARCHAR2) IS
BEGIN
    INSERT INTO CRACHA VALUES (
        SEQ_CRACHA.nextval,
        DT_EMISSAO_CRACHA
        CPF_FUNCIONARIO
    );
    DBMS_OUTPUT.PUT_LINE('Crachá emitido');
END;

CREATE OR REPLACE PROCEDURE PROC_CADASTRAR_PROMOCAO (DESCONTO VARCHAR2 DEFAULT NULL) IS
BEGIN
    INSERT INTO PROMOCAO VALUES (
        SEQ_PROMOCAO.nextval,
        DESCONTO
    );
    DBMS_OUTPUT.PUT_LINE('Promoção cadastrada');
END;
...
CREATE OR REPLACE PROCEDURE PROC_CADASTRAR_RESPONSAVEL (CPF_HOSPEDE VARCHAR2, CONTA_RESPONSAVEL VARCHAR2 DEFAULT NULL) IS
BEGIN
...
CREATE OR REPLACE PROCEDURE PROC_CADASTRAR_HOSPEDAGEM (COD_HOTEL NUMBER, NUM_FLAT NUMBER, DT_INIC VARCHAR2 DEFAULT NULL, DT_FIM VARCHAR2 DEFAULT NULL) IS
BEGIN
...
CREATE OR REPLACE PROCEDURE PROC_CADASTRAR_RESPONSAVEL_PAGA_HOSPEDAGEM (CPF_HOSPEDE VARCHAR2, COD_HOSPEDAGENS NUMBER, COD_PROMOCAO NUMBER DEFAULT NULL) IS
BEGIN
    INSERT INTO PROMOCAO VALUES (
        CPF_HOSPEDE,
        COD_HOSPEDAGENS,
